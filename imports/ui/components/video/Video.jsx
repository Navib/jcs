    ...
    scrollbar.addListener(function() {
      ...
      switch (scrollPos) {
        ...
        case blackSection:
          ...
          break;
        case imageSection:
          $('.odd-ani').css({'right': '0', 'transition': 'all .3s ease-in', 'opacity': '1', 'visibility': 'visible'});
          $('.even-ani').css({'left': '0', 'transition': 'all .3s ease-in', 'opacity': '1', 'visibility': 'visible'});
        ...
        <div className="fullscreen-bg">
          <div className="video-overlay">
            <div className="hvr-box fade-out">
              ...
              <h1 className="video-header-text-small">It is a long established fact that a reader will be distracted
              </h1>
            </div>
          </div>
