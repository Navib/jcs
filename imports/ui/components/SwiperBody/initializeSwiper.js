  ...
  var initializeSwiper = new Swiper ('.swiper-container', {
    ...
    pagination: {
      ...
      renderCustom: function (swiper, current, total) {
        ...
        var names = [
             {id:1 ,name:'Justin-1',src:'http://via.placeholder.com/350x150?text=Justin-1'},
             {id:2 ,name:'Justin-2',src:'http://via.placeholder.com/350x150?text=Justin-2'},
             {id:3 ,name:'Justin-3',src:'http://via.placeholder.com/350x150?text=Justin-3'},
             {id:4 ,name:'Justin-4',src:'http://via.placeholder.com/350x150?text=Justin-4'},
             {id:5 ,name:'Justin-5',src:'http://via.placeholder.com/350x150?text=Justin-5'},
          ];
