  ...
  render() {
    return (
      <div className="jcs-contact-wrapper ">
        <div className="exit-contact-wrapper">
          <a href="#" className="exit-contact-btn x"></a>
        </div>
        <div className="flex-contact">
          <div className="flex-50">
            <h3>For Inquries see contact information below</h3>
            <div className="flex-name flex-item">Justin C. Schilling</div>
            <div className="flex-email flex-item">
              <a href="demoEmail@email.com">demoEmail@email.com</a>
            </div>
            <div className="flex-number flex-item">
              <a href="demoEmail@email.com">Click To Call</a>
            </div>
